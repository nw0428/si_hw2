...
# sanity check! A Matrix that is a square Matrix?
puts M.is_a? Matrix
puts M.row_count == M.column_count

# can we read rows as we expect?
puts M[0,0].to_s
puts M[1,1].to_s
puts M[2,2].to_s
puts M[3,3].to_s
...
k, l, m, n = Item.new(8,0,0), Item.new(49,1,1), Item.new(31,3,3), Item.new(23,4,4)
k.to_s
l.to_s
m.to_s
n.to_s
...
my_adj = Num_adj.new(k)
my_adj.push(l)
my_adj.push(m)
my_adj.push(n)
print my_adj.product.to_s
puts " "
my_adj.adj_print

puts "Matrix size"
puts "rows" 
puts M.row_count.to_s
puts "cols" 
puts M.column_count.to_s
